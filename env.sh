...
DOCKER_BUILD="docker build -f $DOCKERFILE_CPU_NAME \
	--env TENSORFLOW_CONTAINER_NAME_CPU=$TENSORFLOW_CONTAINER_NAME_CPU \
	-t $TENSORFLOW_CONTAINER_NAME_CPU ."
...
NVIDIA_DOCKER_BUILD="nvidia-docker build -f $DOCKERFILE_GPU_NAME \
	--env TENSORFLOW_CONTAINER_NAME_GPU=$TENSORFLOW_CONTAINER_NAME_GPU \
